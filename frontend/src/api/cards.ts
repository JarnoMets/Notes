...
export const cardsApi = {
  ...
  create: (listId: string, data: { title: string; description?: string; position?: number; due_date?: string; labels?: string[] }) => 
    api.post(`/lists/${listId}/cards`, data),
  update: (id: string, data: { title?: string; description?: string; position?: number; due_date?: string; labels?: string[]; archived?: boolean; list_id?: string }) => 
